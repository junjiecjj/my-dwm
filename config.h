...
static char selbordercolor[]        = "#00FF00";
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,                XK_e,                    quit,           {0} },                  //Ctrl+Alt+del，关闭并退出整个dwm桌面，且强制关闭所有当前运行于dwm下的程序
    ...
    */
    ...
    { MODKEY,              XK_w,                    focusstack,     {.i = +1 } },	  // win+q 将光标焦点移动到上一个窗格,在同一个标签页的不同窗口间切换,
    { MODKEY,              XK_q,                    focusstack,     {.i = -1 } },     // win+w 将光标焦点移动到下一个窗格,在同一个标签页的不同窗口间切换,
